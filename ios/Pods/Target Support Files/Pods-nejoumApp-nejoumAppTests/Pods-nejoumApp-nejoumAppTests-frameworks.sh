...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNAudioRecorderPlayer/RNAudioRecorderPlayer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNFlashList/RNFlashList.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNSharedElement/RNSharedElement.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-blob-util/react_native_blob_util.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-document-picker/react_native_document_picker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-image-base64/react_native_image_base64.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-image-picker/react_native_image_picker.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-notifications/RNNotifications.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-pager-view/react_native_pager_view.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-pdf/react_native_pdf.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-progress-view/react_native_progress_view.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-restart/react_native_restart.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-version-check/react_native_version_check.framework"
