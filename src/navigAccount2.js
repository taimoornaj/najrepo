...
//function Dashboard () {
export default class NavigAccount extends Component {
        ...
        return (
            <SafeAreaView style={{flex:1, backgroundColor:'#EDEDED'}}>  
                ...
                <View style={{ flexDirection:'row', marginTop:'10%', 
                    ...
                    <TouchableOpacity
                      onPress = {() => this.props.navigation.navigate('inauctionsDetailsstmt')}
                                ...
                                <View style={{flex: 1, flexDirection:'column'}}>
                                    <Text style={[commonStyle.fontsizeGlobalbig, {textAlign:I18n.locale=='en'?'left':'right',  color: '#343D40',
                                     fontSize:width*0.05, fontWeight:'500', marginBottom: '4%'}]}>
                                        {strings('main.auction_cars')}</Text>
                                    <Text style={[commonStyle.fontsizeGlobalbig, {textAlign:I18n.locale=='en'?'left':'right',  color: '#707070', 
                                textAlign:
                                I18n.locale=='en'?'left':'right', fontSize:width*0.04}]}>
                                        {strings('main.auctionCarsAccountsDes')}</Text>
                                </View>
                            </View>
                        </Animatable.View>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                      onPress = {() => this.props.navigation.navigate('shippingCostDetailsStmt')}
                      style={{justifyContent:'center', alignItems:'center',
                          padding:'6%',
                          margin:'2%',
                          borderRadius:10,
                          ...
                          duration = {2000}>
                            <View style={{flexDirection:'row', justifyContent:'center', alignItems:'center',flex:1,}}>
                                ...
                                <View style={{flex: 1, flexDirection:'column'}}>
                                    <Text style={[commonStyle.fontsizeGlobalbig, {textAlign:I18n.locale=='en'?'left':'right',  color: '#343D40',
                                     fontSize:width*0.05, fontWeight:'500', marginBottom: '4%'}]}>
                                        {strings('car.arrived_car')}</Text>
                                    <Text style={[commonStyle.fontsizeGlobalbig, {textAlign:I18n.locale=='en'?'left':'right',  color: '#707070', 
                                textAlign:I18n.locale=='en'?'left':'right',  fontSize:width*0.04}]}>
                                        {strings('main.arrivedCarsAccountsDes')}</Text>
                                </View>
                            </View>
                        </Animatable.View>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                      onPress = {() => this.props.navigation.navigate('navigAccount',
                          ...
                          duration = {2000}>
                            <View style={{flexDirection:'row', justifyContent:'center', alignItems:'center',flex:1,}}>
                                ...
                                <View style={{flex: 1, flexDirection:'column', width:'100%'}}>
                                    <Text style={[commonStyle.fontsizeGlobalbig, {textAlign:I18n.locale=='en'?'left':'right',  color: '#343D40',
                                     fontSize:width*0.05, fontWeight:'500', marginBottom: '4%'}]}>
                                        {strings('main.details_account')}</Text>
                                    <Text style={[commonStyle.fontsizeGlobalbig, {textAlign:I18n.locale=='en'?'left':'right',  color: '#707070', 
                                textAlign:I18n.locale=='en'?'left':'right',  fontSize:width*0.04}]}>
                                        {strings('main.detailsAccountsDes')}</Text>
                                </View>
                            </View>
                        </Animatable.View>
                    </TouchableOpacity>
