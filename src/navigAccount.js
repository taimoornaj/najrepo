            ...
            <SafeAreaView style={{flex:1, backgroundColor:'#EDEDED'}}>  
                <View style={{flex:1, alignItems:'center', }}>
                    <View style={{ flexDirection:'row', marginTop:'10%', 
                        ...
                        <Text style={{color:'#343D40',}}>{strings('main.myaccountDES')}</Text>
                    </View>
                    <TouchableOpacity
                    onPress = {() => this.props.navigation.navigate('generalStatement')}
                          ...
                          duration = {2000}>
                            <View style={{flexDirection:'row', justifyContent:'center', alignItems:'center',flex:1,}}>
                                ...
                                <View style={{flex: 1, flexDirection:'column'}}>
                                    <Text style={[commonStyle.fontsizeGlobalbig, {textAlign:I18n.locale=='en'?'left':'right', color: '#343D40',
                                     fontSize:width*0.05, fontWeight:'500', marginBottom: '4%'}]}>
                                        {strings('car.car_statement')}</Text>
                                    <Text style={[commonStyle.fontsizeGlobalbig, {textAlign:I18n.locale=='en'?'left':'right', color: '#707070', 
                                textAlign:I18n.locale=='en'?'left':'right', fontSize:width*0.04}]}>
                                        {strings('main.carStatementDes')}</Text>
                                </View>
                            </View>
                        </Animatable.View>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                      onPress = {() => this.props.navigation.navigate('debitCarsStatement',
                        ...
                        <Animatable.View
                          ...
                          duration = {2000}>
                            <View style={{flexDirection:'row', justifyContent:'center', alignItems:'center',flex:1,}}>
                                <View style={{flex: 0.3}}>
                                    <Image
                                      source={require('../assets/images/general_statement.png')}
                                      resizeMode={"contain"}
                                      style={commonStyle.image3d6}
                                    />
                                </View>
                                <View style={{flex: 1, flexDirection:'column', width:'100%'}}>
                                    <Text style={[commonStyle.fontsizeGlobalbig, {textAlign:I18n.locale=='en'?'left':'right', color: '#343D40',
                                     fontSize:width*0.05, fontWeight:'500', marginBottom: '4%'}]}>
                                        {strings('car.general_statement')}</Text>
                                    <Text style={[commonStyle.fontsizeGlobalbig, {textAlign:I18n.locale=='en'?'left':'right', color: '#707070', 
                                textAlign:I18n.locale=='en'?'left':'right', fontSize:width*0.04}]}>
                                        {strings('main.generalStatementDes')}</Text>
                                </View>
                            </View>
                        </Animatable.View>
                    </TouchableOpacity>
