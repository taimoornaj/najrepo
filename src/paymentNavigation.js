...
export default class PaymentNavigation extends Component {
    constructor(props){
        super(props);
        this.state = {
            loader      : false,
    ...
    render(){
        ...
        return (
            ...
            <View style={{ flexDirection:'row', 
                    ...
                    {strings('main.PaymentDES')}</Text>
            </View>
                <TouchableOpacity
                  onPress = {() => this.props.navigation.navigate('paymentCars')}
                        ...
                        <View style={{flexDirection:'row', justifyContent:'center', alignItems:'center',flex:1,}}>
                            ...
                            <View style={{flex: 1, flexDirection:'column'}}>
                                ...
                                <Text style={[commonStyle.fontsizeGlobalbig, {textAlign: I18n.locale=='en'?'left':'right', color: '#707070', 
                                    ...
                                    {strings('main.carsPaymentDes')}</Text>
                            </View>
                        </View>
                    </Animatable.View>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress = {() => this.props.navigation.navigate('paymentOther')}
                  style={{justifyContent:'center', alignItems:'center',
                      padding:'6%',
                      margin:'2%',
                      borderRadius:10,
                        ...
                        <View style={{flexDirection:'row', justifyContent:'center', alignItems:'center',flex:1,}}>
                            ...
                            <View style={{flex: 1, flexDirection:'column'}}>
                                <Text style={[commonStyle.fontsizeGlobalbig, {textAlign: I18n.locale=='en'?'left':'right', color: '#343D40',
                                 fontSize:width*0.05, fontWeight:'500', marginBottom: '4%'}]}>
                                    {strings('main.otherPayments')}</Text>
                                <Text style={[commonStyle.fontsizeGlobalbig, {textAlign: I18n.locale=='en'?'left':'right', color: '#707070', 
                            textAlign: I18n.locale=='en'?'left':'right', fontSize:width*0.04}]}>
                                    {strings('main.otherPaymentsDes')}</Text>
                            </View>
                        </View>
                    </Animatable.View>
                </TouchableOpacity>
